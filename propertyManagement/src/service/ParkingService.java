...
public class ParkingService {
     ...
     */
    public int tempParking(TemporaryParkingSpace space){
     ...
     * @return 0表示操作完成，1表示已有人使用，2表示没有该车位
     */
    public int addTempParkingRecord(TemporaryParkingSpace space, String carId, Date startTime, Date endTime, float cost){
        space = tempDao.getTemporaryParkingSpace(space.getParking_space_id());
        if (space == null) return 2;
        else if (space.getParking_state() == 1) return 1;
        else {
...
//        if (ownedRecordDao.getRecordBySpaceId(space.getParking_space_id()) != null) return 1;
//
//    }
}
